...
static const uint64_t superblock_addrs[BTRFS_SUPER_MIRROR_MAX] = {
...
/* Allocation-side support is required before any compat-ro bit is writable. */
#define BTRFS_FEATURE_COMPAT_RO_WRITE_SUPPORTED	0
...
#define BTRFS_FEATURE_INCOMPAT_KNOWN			\
