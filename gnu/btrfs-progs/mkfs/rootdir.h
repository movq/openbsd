...
int btrfs_mkfs_validate_source_dir(const char *source_dir);
int btrfs_mkfs_validate_target(const char *source_dir, const char *target);
...
int btrfs_mkfs_size_dir(const char *dir_name, u32 sectorsize, u64 min_dev_size,
			u64 meta_profile, u64 data_profile, u64 *size_ret);
