...
/* OpenZFS re-entrant reader/writer locks for OpenBSD. */

#ifndef _SPL_SYS_RRWLOCK_H
#define _SPL_SYS_RRWLOCK_H
 ...
 * scoped to the shared OpenZFS header.
 */
#include <sys/types.h>
