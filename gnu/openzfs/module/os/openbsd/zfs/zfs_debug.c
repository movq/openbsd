 ...
 *
 * The debug message log is exported through the native kstat subsystem.
 */
...
__zfs_dbgmsg(char *buf)
{
	...
	memcpy(zdm->zdm_msg, buf, size - sizeof (*zdm));
...
{
	/*
	 * Enable this by setting ZFS_DEBUG_SET_ERROR in zfs_flags.
	 */
